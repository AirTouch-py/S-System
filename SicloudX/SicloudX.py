...
import calendar
#语言
language=input("输入语言 Enter language(中文简体 English)：")
...
if language=="中文简体":
    ...
    系统版本：
        ...
        Silicon®有限公司版权所有
            ...
            webbrowser.open("https://iqiyi.com/weidianying")
    ...
    {4}。
            ...
            print("加密成功")
            time.sleep(0.5)
            print("加密后的内容是:{}".format("".join(last)))

        elif cmd== "解密机":
            last = []
            string = input("输入你要解密的内容(使用Silicon®加密机加密的内容):")
            for i in string:
                last.append(chr(ord(i) - 10))
            time.sleep(1)
            print("解密成功")
            ...
            if __name__ == "__main__":
                ...
                w.place(x=60, y=385)
                button_restart = Button(root, text="新", font=('楷体', 15), bg="#AAAAAA", fg="blue", command=restart)
...
#英文版
    ...
    Silicon® Copyright Limited
                ...
                for row in range(16):
                    for col in range(16):
                        if (control_list[row][col] == -1):
                            ...
                            label_list[row][col] = Label(root, text="1", font=('arial', 15, 'bold'), fg="red",
                                                         bg="#AAAAAA",
                                                         relief=RIDGE)
                            label_list[row][col].place(x=17 + col * 20, y=46 + row * 20, height=20, width=20)
                        elif (control_list[row][col] == 2):
                            ...
                            label_list[row][col] = Label(root, text="5", font=('arial', 15, 'bold'), fg="red",
                                                         bg="#AAAAAA",
                                                         relief=RIDGE)
                            label_list[row][col].place(x=17 + col * 20, y=46 + row * 20, height=20, width=20)
                        elif (control_list[row][col] == 6):
            ...
            if __name__ == "__main__":
                ...
                time_counter(time_label)
                root.mainloop()  # 监控组件，组件发生变化或触发事件时，更新窗口
        elif cmd=="random password generator":
            try:
